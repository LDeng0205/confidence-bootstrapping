...
from models.old_all_atom_score_model import TensorProductScoreModel as OldAAScoreModel
from models.old_score_model import TensorProductScoreModel as OldCGScoreModel
...
def get_model(args, device, t_to_sigma, no_parallel=False, confidence_mode=False, old=False):
    ...
    if old:
        if 'all_atoms' in args and args.all_atoms:
            model_class = OldAAScoreModel
        else:
            model_class = OldCGScoreModel
