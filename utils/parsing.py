...
def parse_train_args():
    ...
    parser.add_argument('--pdbsidechain_dir', type=str, default='/data/rsg/nlp/gcorso/ligbind/data/pdb_2021aug02_sample', help='')
    ...
    # bootstrapping
    parser.add_argument('--add_bootstrapping_dataset', action='store_true', default=False, help='')
    parser.add_argument('--original_model_dir', type=str, default="workdir", help='')
    parser.add_argument('--original_model_ckpt', type=str, default="best_model.pt", help='')
    parser.add_argument('--confidence_model_dir', type=str, default="workdir/masked_confidence_model", help='')
    parser.add_argument('--confidence_model_ckpt', type=str, default="best_model.pt", help='')
    ...
    parser.add_argument('--bootstrapping_dataset_iterations', type=int, default=1, help='')
    parser.add_argument('--bootstrapping_dataset_confidence_cutoff', type=float, default=0, help='')
    parser.add_argument('--bootstrapping_dataset_max_per_complex', type=int, default=1000, help='')
    parser.add_argument('--bootstrapping_fixed_length', type=int, default=None, help='')
    parser.add_argument('--bootstrapping_temperature', type=float, default=0, help='')
