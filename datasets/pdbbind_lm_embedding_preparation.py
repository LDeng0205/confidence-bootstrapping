...
parser.add_argument('--data_dir', type=str, default='data/posebusters_benchmark_set', help='')
parser.add_argument('--chain_cutoff', type=int, default=100000, help='')
parser.add_argument('--out_file', type=str, default="data/posebusters_sequences.fasta")
