...
class PDBBind(Dataset):
    def __init__(self, root, transform=None, cache_path='data/cache', split_path='data/', limit_complexes=0, chain_cutoff=10,
                 ...
                 cross_docking=False, include_miscellaneous_atoms=False,
                 ...
                 knn_only_graph=False, matching_tries=1, bootstrapping=False, dataset='PDBBind'):
...
def print_statistics(complex_graphs):
    ...
    with open('pdbbind_receptor_sizes.pkl', 'wb') as f:
        pickle.dump(receptor_sizes, f)
