...
parser.add_argument('--model_dir', type=str, default='workdir/combined_flex_masked_cut10max80_lmax1_emb48_unrollbs12min2', help='Path to folder with trained score model and hyperparameters')
...
for idx, orig_complex_graph in tqdm(enumerate(test_loader)):
    ...
    try:
        ...
        data_list, confidence = sampling(data_list=data_list, model=model,
                                         ...
                                         filtering_data_list=confidence_data_list, filtering_model_args=confidence_args,
